...
-- LEDR[6]	=>  Location: PIN_AF15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[5]	=>  Location: PIN_AH12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[4]	=>  Location: PIN_AB16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDR[3]	=>  Location: PIN_AC14,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- LEDR[0]	=>  Location: PIN_Y15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[3]	=>  Location: PIN_AD14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[7]	=>  Location: PIN_AE16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[9]	=>  Location: PIN_AB14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[8]	=>  Location: PIN_AH17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[2]	=>  Location: PIN_AG17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[1]	=>  Location: PIN_AE15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[0]	=>  Location: PIN_AF16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[6]	=>  Location: PIN_AA16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[5]	=>  Location: PIN_AD15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[4]	=>  Location: PIN_AC15,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\inst|Mux0~0_combout\ & ((\inst|Mux1~3_combout\) # ((\inst|Mux0~1_combout\)))) # (!\inst|Mux0~0_combout\ & (((!\inst|Mux0~1_combout\ & \inst|Add0~10_combout\))))
...
-- Equation(s):
-- \inst|Mux2~3_combout\ = (\inst|Mux2~2_combout\ & ((\SW[9]~input_o\) # ((\inst|Mod0|auto_generated|divider|divider|StageOut[13]~8_combout\) # (\SW[8]~input_o\))))
...
-- Equation(s):
-- \inst|Mux3~3_combout\ = (\inst|Mux0~0_combout\ & ((\inst|Mux3~2_combout\) # ((\inst|Mux0~1_combout\)))) # (!\inst|Mux0~0_combout\ & (((!\inst|Mux0~1_combout\ & \inst|Add0~6_combout\))))
...
-- Equation(s):
-- \inst|m[2]~9_combout\ = (\SW[9]~input_o\ & (\inst|Mult0|auto_generated|op_3~12_combout\ & (!\SW[10]~input_o\ & !\SW[8]~input_o\)))
