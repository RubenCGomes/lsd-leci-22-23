...
-- *****************************************************************************
-- Generated on "03/19/2023 20:27:33"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          FreqDividerTest
-- 
...
ENTITY FreqDividerTest_vhd_vec_tst IS
END FreqDividerTest_vhd_vec_tst;
ARCHITECTURE FreqDividerTest_arch OF FreqDividerTest_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL clkIn : STD_LOGIC;
SIGNAL clkOut : STD_LOGIC;
SIGNAL k : STD_LOGIC_VECTOR(31 DOWNTO 0);
COMPONENT FreqDividerTest
	PORT (
	clkIn : IN STD_LOGIC;
